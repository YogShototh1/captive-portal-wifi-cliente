...
$portalHist  = ($portalHabil && $rotAtivo !== null) ? portal_hist($rotAtivo)  : [];

$lgpd    = $rotAtivo !== null ? lgpd_get($rotAtivo) : lgpd_padrao($tipoPainel);
...
<body class="painel-cliente">
    ...
    <div class="pc-layout">
        ...
        <div class="pc-shell">
                ...
                <div class="pc-topbar-right">
                    ...
                    <details class="rt-sel">
                        ...
                        <div class="rt-menu">
                            ...
                            <?php endforeach; ?>
                            <a class="rt-item rt-item-all<?= $rotAtivo === null ? ' atual' : '' ?>" href="?r=">
                ...
                <div class="glow-card pc-table-card">
                    ...
                    <div class="glow-body">
                        <div class="pc-table-wrap" id="leads-live"
                             data-endpoint="api/leads_online.php?roteador=<?= urlencode((string) $rotAtivo) ?>&amp;filtro=<?= urlencode($filtro) ?>"
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php if (!$leads): ?>
                                        <tr class="pc-empty-row"><td colspan="8" class="pc-vazio">Nenhum lead ainda. Assim que um cliente conectar no Wi-Fi, aparece aqui.</td></tr>
            ...
            <?php /* Nada de deixar a marcação escondida por CSS: cada uma destas
                     telas tem um data-endpoint que o JS busca ao abrir. Fora do
                     HTML, nem o menu nem as chamadas existem. */ ?>
            <?php if (!$hospedagem): ?>
                    ...
                    <div class="glow-body">
                        <div class="pc-dst">
                            ...
                            <?php /* Tempo limite não existe na pousada: quem corta o
                                     acesso do hóspede é o check-out, não um cronômetro
                                     de minutos. Deixar o campo aqui só criaria um
                                     segundo dono da mesma decisão. */ ?>
                            <?php if (!$hospedagem): ?>
