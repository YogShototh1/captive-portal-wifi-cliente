...
// Uma linha por PESSOA (mesmo telefone em vários MikroTiks do cliente vira uma
// linha só). Ver leads_pagina() em inc/util.php.
...
$alertasMarcados = alertas_get((int) $id);
...
<body class="painel-cliente">
    ...
    <div class="pc-layout">
        ...
        <div class="pc-shell">
            ...
            <!-- ============ ABA: ALERTAS ============ -->
            <?php $alertasClienteId = (int) $id; require __DIR__ . '/inc/alertas_tela.php'; ?>
            ...
            <section class="pc-tela" data-tela="informacoes">
                <div class="glow-card pc-dst-card">
                    ...
                    <div class="glow-body">
                        <?php
                        $infoEndpoint = 'api/dashboard.php?' . ($rotAtivo !== null ? 'roteador=' . urlencode($rotAtivo) : 'cliente_id=' . (int) $id);
                        $infoHosp     = $hospedagem;
                    ...
                    <div class="glow-body">
                        <div class="pc-anuncio">
                            ...
                            <div class="pc-anuncio-form">
                                ...
                                <?php $mhTipo = 'anuncio'; $mhClienteId = (int) $id; require __DIR__ . '/inc/midia_hist_tela.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="glow-body">
                        <div class="pc-anuncio">
                            ...
                            <div class="pc-anuncio-form">
                                ...
                                <?php $mhTipo = 'logo'; $mhClienteId = (int) $id; require __DIR__ . '/inc/midia_hist_tela.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="glow-body">
                        <div class="pc-dst">
                            ...
                            <div class="pc-dst-ig">
                                ...
                                <span class="pc-dst-ig-dica">Monte uma página com a cara do cliente para receber quem sai do anúncio e mandar para o perfil dele.</span>
                            </div>
                        </div>
                    </div>
                </div>
                <?php $igClienteId = (int) $id; require __DIR__ . '/inc/ig_modal.php'; ?>
                <?php else: echo $avisoRoteador; endif; ?>
            </section>
