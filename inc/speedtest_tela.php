    ...
    <div class="glow-card pc-dst-card">
        ...
        <div class="glow-body">
            <div class="pc-dst" id="speedrt-box"
                ...
                <p class="pc-anuncio-desc">Mede a internet que chega no <strong>MikroTik <?= h((string) $rotAtivo) ?></strong>, sem precisar ir até a loja. O roteador faz o teste na próxima rodada — o resultado leva cerca de um minuto para aparecer aqui.</p>
